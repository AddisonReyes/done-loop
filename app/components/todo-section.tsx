    ...
    <section className="glass-panel float-in rounded-[28px] px-5 py-5 [animation-delay:300ms] sm:px-6">
      ...
      <div className="mt-5 flex gap-2">
        ...
        <button
          type="button"
          onClick={onAddTodo}
          className="h-11 shrink-0 rounded-xl bg-white/8 px-4 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-white/12 focus:outline-none focus:ring-2 focus:ring-purple-500/70"
        >
          Add task
        </button>
      </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-purple-600 px-3 py-2 text-xs font-semibold text-white shadow-[0_6px_16px_rgba(147,51,234,0.14)] transition-all hover:-translate-y-0.5 hover:bg-purple-500 hover:shadow-[0_8px_18px_rgba(147,51,234,0.18)] focus:outline-none focus:ring-2 focus:ring-purple-500/55"
              >
                Done
              </button>
            </div>
